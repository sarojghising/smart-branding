                                    ...
                                    @isset($influencers)
                                        @foreach ($influencers as $key => $value)
                                            ...
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>
                                                    @if (file_exists(public_path() . '/storage/images/profile/' . $value->image) && $value->image != null)
                                                        <img src="{{ asset('storage/images/profile/' . $value->image) }}"
                                                            alt="image" width="50">
                                                    @else
                                                ...
                                                <td>
                                                    <form action="{{ route('brand.delete.influencer', $value->id) }}"

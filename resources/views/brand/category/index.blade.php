                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('brand.categories.edit', $category->id) }}" class="btn btn-info btn-sm"> <i class="fa fa-eye"></i></a>
                                        <form action="{{ route('brand.categories.destroy',$category->id) }}" method="post" onsubmit="return confirm('Are you sure?')" class="mt-2">
                                            @csrf
                                            @method('DELETE')
